...
# USDC token address on Base Mainnet (optional, will use default if not set)
# USDC_TOKEN_ADDRESS=
...
# Run deployment
echo "Running deployment script on Base Mainnet..."
VERIFY_CONTRACTS=$VERIFY npx hardhat run deploy-vault.js --network base
