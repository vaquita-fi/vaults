...
# USDC token address on Base Sepolia (optional, will use default if not set)
# USDC_TOKEN_ADDRESS=
...
# Run deployment
echo "Running deployment script on Base Sepolia..."
VERIFY_CONTRACTS=$VERIFY npx hardhat run deploy-vault.js --network baseSepolia
